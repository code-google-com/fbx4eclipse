...
void MMHImportImpl::PosRotScaleNode(KFbxNode *n, KFbxXMatrix& m3, PosRotScale prs)
{
...
void MMHImportImpl::PosRotScaleNode(KFbxNode *n, KFbxVector4 & p, KFbxQuaternion& q, float s, PosRotScale prs)
{
...
void MMHImportImpl::PosRotScaleNode(KFbxNode *n, KFbxVector4 & p, KFbxQuaternion& q, KFbxVector4 & s, PosRotScale prs)
{
