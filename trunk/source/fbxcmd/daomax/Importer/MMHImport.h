...
// MMH Importer
class MMHImporter : public BaseImporter//, public IniFileSection
{
public:
   MMHImporter(const TCHAR *Name,ImpInterface *I,Interface *GI, BOOL SuppressPrompts);
